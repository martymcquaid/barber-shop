...
- **Dev Server URL**: `http://127.0.0.1:5210`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/5f01b666-4854-4165-904a-52bb8d3f82da/preview`
- **Port**: `5210`
...
4. The dev server is accessible at `http://127.0.0.1:5210`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/5f01b666-4854-4165-904a-52bb8d3f82da/preview`
