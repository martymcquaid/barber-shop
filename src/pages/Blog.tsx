...
export default function Blog() {
  const posts = [
    ...
    { title: 'Choosing the Right Shampoo', description: 'What to look for based on your hair type.', image: 'https://images.unsplash.com/photo-1525973454080-7f0f1d1b8eca?q=80&w=1200&auto=format&fit=crop' },
    ...
    <Layout>
      <section aria-label="Blog" className="py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {posts.map((p, idx) => (
            <article key={idx} className="bg-white rounded-xl shadow-md overflow-hidden transform hover:shadow-xl hover:translate-y-1 transition-all duration-300">
